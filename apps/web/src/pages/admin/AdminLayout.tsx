...
import { Users, Settings, LogOut, User, ChevronRight } from 'lucide-react'
      ...
      <div style={{ padding: '24px 20px 20px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ color: '#67e8f9', fontFamily: 'Outfit, sans-serif', fontSize: 10, marginTop: 2 }}>Super Admin</div>
          </div>
        </div>
      </div>
